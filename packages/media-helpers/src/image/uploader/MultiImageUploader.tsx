...
// import { type FieldArrayWithId, type UseFieldArrayAppend, type UseFieldArrayRemove } from 'react-hook-form'
...
// export function MultiImageUploader({ imageFields, appendImage, removeImage }: MultiImageUploaderProps) {
//   return (
